...
class ArticleCreate(StrictBaseModel):
    ...
    internal: bool = Field(
        description="Whether the article is internal (True) or customer-visible (False). Required: a forgotten flag must fail validation rather than silently default to public."
    )
